...
public class AIController : CSComponent {
    ...
    public bool in_senses_radius => m_player.CharacterPosititon.Distance(m_target.CharacterPosititon) <= 1000;
    public bool out_senses_radius => m_player.CharacterPosititon.Distance(m_target.CharacterPosititon) > 1000;
