...
void Attachable::OnInit() {
	...
	if (s_attachableCount == 0) {
		...
		auto defuseColodShader = "../../data/engine/shaders/opaque_defuse_color.hlsl";

		s_meshMaterial = meshAsset->CreateDynamicMaterial("Generated by Attachaable", defuseColodShader);
		s_boundMaterial = meshAsset->CreateDynamicMaterial("Generated by Attachaable", defuseColodShader);
